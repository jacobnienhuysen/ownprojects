...
if(isbn10!=null && isbn13==null){
...
else if(isbn13!=null && isbn10==null){
	aISBN = "lit_isbn13";
	bISBN = isbn13;
	cISBN = aISBN+"="+isbn13;
	dISBN = aISBN + " = ?";
	...
	twoIsbn = true;
	aISBN = "lit_isbn10, lit_isbn13";
	bISBN = isbn10+", "+isbn13;
	cISBN = "lit_isbn10="+isbn10+", lit_isbn13="+isbn13;
	dISBN = "(lit_isbn10 = ? OR lit_isbn13 = ?)";
}
...
rs3 = null;
	...
	if(bokAntal>0){ 	//om det redan finns en bok med inmatad titel och isbn-nummer i registret.
		...
		if(twoIsbn){ //Om båda ISBN-numren angivits
			String sq2 = "INSERT INTO book_literature (lit_title, lit_published, lit_isbn10, lit_isbn13, lit_info_text) VALUES (?,?,?,?,?)";
			...
			String sq2 = "INSERT INTO book_literature (lit_title, lit_published, lit_isbn10, lit_info_text) VALUES (?,?,?,?)";
			pst2 = c1.prepareStatement(sq2);
			pst2.setString(1, title);
			pst2.setString(2, bookYear);
			pst2.setString(3, isbn10);
			pst2.setString(4, infoText);
			pst2.executeUpdate();
			...
			String sq2 = "INSERT INTO book_literature (lit_title, lit_published, lit_isbn13, lit_info_text) VALUES (?,?,?,?)";
			pst2 = c1.prepareStatement(sq2);
			pst2.setString(1, title);
			pst2.setString(2, bookYear);
