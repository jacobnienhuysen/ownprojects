...
c1 = bookbookDB.getConnection();
	...
	String sq1 = " INSERT INTO book_literature_discussion_comment (lidi_ldid, lidi_uid, lidi_text) VALUES ('"+did+"', '"+fn+"', '"+com+"')";
	
	s1.executeUpdate(sq1);

    if(c1!=null) c1.close();

response.sendRedirect("activityadd.jsp?id=6&val="+did+"");
}
