...
<html>
  ...
  <head>
   ...
   <link href="bootstrap-responsive.css" rel="stylesheet"> 
    ...
    <tr valign="middle"><td><input type="text" name="isbn10" id="ISBN10f" maxlength="10" placeholder="" data-original-title="10 siffror" data-placement="right"></td></tr>
   
	<tr><td><b>ISBN 13</b></td></tr>
    <tr valign="middle"><td><input type="text" name="isbn13" id="ISBN13f" maxlength="13" placeholder="" data-original-title="13 siffror" data-placement="right"></td></tr>
