...
$query = "SELECT * FROM bab_annons_sal WHERE ann_aid='".$id."'";
...
?>
	...
	<div class="annons">
		...
		<div class="left">
			...
			<div class="price"><?= $obj->ann_price ?> kr</div>
			...
			<div class="info">	<?php if ($obj->ann_phone != NULL){
								...
								<?php if($obj->ann_email != NULL){
									echo '<img src="pics/mail.png" width="25" style="vertical-align: middle;"> <a href="mail.php?id='. $mid .'&int=true"$_POST["mail"];>Maila annonsören</a>';
								}?>
			</div>
		</div>
		<div class="line"><hr></div>
